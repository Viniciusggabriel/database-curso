...
-- Selecionanado itens da view
SELECT
	*
FROM
	VIEW_RELATORIO;

-- Também é possível fazer um insert e delete pela view, porem sem o inner join já o update é possível fazer em uma com o inner join
CREATE TABLE
	ALUNOS (NUMERO INT, NOME VARCHAR(30));
...
-- Também funciona por index da coluna,  porem só funciona de acordo com a coluna indexada se colocar o nome pra vincular o order by com a coluna real em vez da seleção use os nomes
SELECT
	*
FROM
	ALUNOS
...
-- Ordena levando em consideração os dois juntos
SELECT
	NOME
FROM
	ALUNOS
...
-- Forma de mudar a ordem de organização 
SELECT
	*
FROM
	ALUNOS
