...
SELECT CAST(PRODUTOS.DS_PRECO AS INT) FROM PRODUTOS;
...
DECLARE
    ...
    INSERT INTO ["RESULTADO SOMA"] VALUES (@RESULTADO)
    PRINT 'VALOR INSERIDO NA TABELA' + CAST(@RESULTADO AS CHAR)
    GO

SELECT * FROM [dbo].["RESULTADO SOMA"]
GO

SP_HELPTEXT TRG_ATUALIZA_PRECO -- VER O CÓDIGO