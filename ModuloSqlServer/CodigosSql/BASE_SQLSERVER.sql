...
INSERT INTO ARTIFICIAL_INTELIGENCE(DS_NAME, DS_ENTERPRISE) VALUES ('CHATGPT1', 'OPENAI')
GO

INSERT INTO USER_IN_AI(DS_USERNAME, DS_PASS, FK_ID_AI) VALUES ('VINICIUS1', '123', 1)
GO

CREATE PROC SELECT_JOIN_USER_IN_AI_AND_ARTIFICIAL_INTELIGENCE @ID_AI VARCHAR(30), @PR_USERNAME VARCHAR(30)
AS
    SELECT UIA.ID_USER, UIA.DS_USERNAME, UIA.DS_PASS, UIA.FK_ID_AI, AI.ID_AI, AI.DS_NAME, AI.DS_ENTERPRISE FROM USER_IN_AI UIA, ARTIFICIAL_INTELIGENCE AI
...
CREATE PROC GET_USERNAME_IN_IA_COUNT @PR_FK_ID_AI INT, @PR_COUNTER INT OUTPUT
AS
